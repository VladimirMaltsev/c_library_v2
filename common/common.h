...
typedef enum MAV_STG_DO
{
   ...
   MAV_STG_DO_IDLE_THROTTLE=5, /* Idle throttle. | */
   MAV_STG_DO_FULL_THROTTLE=6, /* Full throttle. | */
   MAV_STG_DO_TAKEOFF_THROTTLE=7, /* Full throttle. | */
   MAV_STG_DO_RESERVED=8, /* Reserved. | */
   MAV_STG_DO_ENUM_END=9, /*  | */
} MAV_STG_DO;
#endif

/** @brief Enumeration of parachute actions */
#ifndef HAVE_ENUM_MAV_PARACHUTE_DO
#define HAVE_ENUM_MAV_PARACHUTE_DO
typedef enum MAV_PARACHUTE_DO
{
   MAV_PARACHUTE_DO_RELEASE=0, /* Release parachute. | */
   MAV_PARACHUTE_DO_DROP=1, /* Drop parachute. | */
   MAV_PARACHUTE_DO_CLOSE=2, /* Close parachute. | */
   MAV_PARACHUTE_DO_RESERVED=3, /* Reserved. | */
   MAV_PARACHUTE_DO_ENUM_END=4, /*  | */
} MAV_PARACHUTE_DO;
#endif
...
#include "./mavlink_msg_stg_status_new.h"
